 ...
 *
 * Mixes a white silicone base with red and blue pigment by concentration
 * (each in 0..1, measured as pigment mass / material mass) using Mixbox
 * latent-space mixing (Kubelka-Munk). Blue + red yields purple and blue +
 * yellow-ish pigments yield green, the way real pigment does, instead of the
 * muddy gray produced by linear RGB averaging.
 *
